...
An alternative method would be exploiting the marginal and conditional distributions of sample separately $Y$ and $Z$. We present the case where we first sample $Z$ using the marginal distribution and then the $Y$ conditioned on the $Z$ obtained:
